...
export const addApi = async(para) => {
  return await http.post('/api/event', para)
}
// 列表
export const listApi = async(para) => {
  return await http.get('/api/event/list', para)
}
/* // 我的实践列表
...
export const editApi = async(para) => {
  return await http.put('/api/event', para)
}
// 删除
export const deleteApi = async(para) => {
  return await http.delete('/api/event', para)
}
/* // 分配学生
