    ...
    >
      <div slot="content">
        <el-form
          ...
          size="small"
        >
          <el-form-item prop="practiceName" :rules="rules.isNull" label="实践名称">
            <el-input v-model="addModel.practiceName"/>
          </el-form-item>
          <el-form-item prop="practiceType" :rules="rules.select" label="实践类型">
            <el-select
          ...
          <el-form-item prop="stuNum" :rules="rules.twenty" label="学生学号">
            <el-input v-model="addModel.stuNum"/>
          </el-form-item>
          <el-form-item prop="practiceTime" :rules="rules.time" label="实践时间">
            <el-date-picker
          ...
          <el-form-item prop="practiceResult" :rules="rules.isNull" label="实践成果">
            <el-input
              type="textarea"
              autosize
              placeholder="请输入内容"
